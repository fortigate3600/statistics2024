...
function submitValues() {
  ...
  for (let i = 0; i < iterazioni; i++) {
    ...
    meanMeans += result.mean;
    meanVariances += result.variance;
  }
  meanMeans /= iterazioni;
  meanVariances /= iterazioni;
  textmedia.innerText = "media delle medie: " + meanMeans.toFixed(3);
  textvar.innerText = "media delle varianze: " + meanVariances.toFixed(3);
}
